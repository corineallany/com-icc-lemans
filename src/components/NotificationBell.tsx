...
export function NotificationBell() {
  ...
  const { data: notifications } = useQuery({ queryKey: ["notifications"], queryFn: getNotifications, refetchInterval: 30_000 });
